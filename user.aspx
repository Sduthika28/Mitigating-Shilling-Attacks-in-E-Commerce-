    ...
    <!-- team section -->
        ...
        <div class="container py-md-5 py-4">
            <div class="title-heading-w3 text-center mx-auto mb-5 pb-sm-4">
                <h3 class="title-main">User <span>Login</span></h3>
            </div>            
        </div>
      <!-- //team setion -->
                     ...
                     <table align="center">
                        <tr>
                            <td class="style3">
                                USER NAME</td>
                            <td class="style3">
                                <asp:TextBox ID="TextBox1" runat="server" Width="192px" required=""></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="style4">
                                PASSWORD</td>
                            <td class="style4">
                                <asp:TextBox ID="TextBox2" runat="server" Width="191px" required="" 
                        ...
                        <tr>
                            ...
                            <td class="style3">
                                <asp:Button ID="Button1" runat="server" Text="LOGIN" Width="193px" 
                        ...
                        <tr>
                            ...
                            <td class="style3">
                                <a href="user_register.aspx">New user register here...</a></td>
                        </tr>
                        <tr>
                            <td class="style2">
                                &nbsp;</td>
