<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="user_register.aspx.cs" Inherits="user_register" %>
    ...
    <!-- team section -->
        ...
        <div class="container py-md-5 py-4">
            <div class="title-heading-w3 text-center mx-auto mb-5 pb-sm-4">
                <h3 class="title-main">User Register</h3>
            </div>            
        </div>
      <!-- //team setion -->
                ...
                <table align="center" class="style1">
                    ...
                    <tr>
                      ...
                      Email</td>
                        <td class="style2">
                            <asp:TextBox ID="TextBox3" runat="server" required="" TextMode="Email"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="style4">
                    ...
                    <tr>
                      ...
                      Password</td>
                        <td class="style5">
                            <asp:TextBox ID="TextBox6" runat="server" required="" TextMode="Password"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                      ...
                      &nbsp;</td>
                        <td>
                            <asp:Button ID="Button1" runat="server" Text="register" Width="184px" 
