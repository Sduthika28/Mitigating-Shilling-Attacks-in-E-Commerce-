<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="user_purchased.aspx.cs" Inherits="user_purchased" %>
    ...
    <!-- team section -->
        ...
        <div class="container py-md-5 py-4">
            <div class="title-heading-w3 text-center mx-auto mb-5 pb-sm-4">
                <h3 class="title-main">Purchase Detais</h3>
            </div>            
        </div>
      <!-- //team setion -->
